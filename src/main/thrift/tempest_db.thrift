...
service TempestDBService extends tempest.TempestService {
  ...
  map<i64, string> getMultiNodeAttributeAsJSON(1:string graph_name, 2:list<i64> nodeIds, 3:string attributeName)
  ...
  list<i64> nodes(1:string graph_name, 2:string sqlClause)
    throws (1: UndefinedGraphException error1, 2: SQLException error2)

  list<i64> outNeighborsWithinKStepsFiltered(1:string graph_name, 2:i64 sourceId, 3:i32 k,
                                                  4:string sqlClause,
  ...
  list<i64> inNeighborsWithinKStepsFiltered(1:string graph_name, 2:i64 sourceId, 3:i32 k,
                                                 4:string sqlClause,
                                                 5: DegreeFilter filter)
    throws (1: UndefinedGraphException error1, 2: tempest.InvalidArgumentException error2,
            3: SQLException error3, 4: tempest.InvalidNodeIdException error4)
  ...
  map<i64, double> ppr(1:string graph_name, 2:list<i64> seeds,
  ...
  void addEdges(1:string graph_name, 2:list<i64> ids1,
                3:list<i64> ids2)
